...
// Navigation items for Chef de Plateau (CP)
const navItems = [
    {
        label: 'Tableau de bord',
        href: route('cp.dashboard'),
        active: route().current('cp.dashboard'),
    },
    {
        label: 'Mes Équipes',
        key: 'teams',
    ...
    <div class="min-h-screen bg-pearl-100 font-sans">
        ...
        <nav class="fixed top-0 left-0 right-0 z-50 bg-charcoal-900 shadow-charcoal border-b border-charcoal-700">
            <div class="flex items-center h-14 px-4">
                <!-- Logo -->
                <Link :href="route('cp.dashboard')" class="flex items-center gap-3 min-w-[200px] border-r border-charcoal-700 pr-5 mr-2 h-full" @click="closeMenus">
                    ...
                    <div class="flex flex-col leading-tight">
                        ...
                        <span class="text-charcoal-400 text-[10px] font-medium tracking-widest uppercase">Chef de Plateau</span>
                    </div>
                </Link>
                ...
                <div class="flex items-center flex-1 h-full ml-4">
                    <template v-for="item in navItems" :key="item.label">
                        ...
                        <div v-else class="relative h-full">
                            ...
                            >
                                <div v-if="openMenu === item.key" class="absolute top-full left-0 mt-0 w-64 bg-white rounded-b-lg shadow-lg border border-pearl-200 overflow-hidden z-50">
                                    <Link
