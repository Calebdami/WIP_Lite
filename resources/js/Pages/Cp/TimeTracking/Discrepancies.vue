    ...
    <CpLayout>
        <template #header>
            <div class="flex justify-between items-end">
                <div>
                    ...
                    <p class="text-xs text-charcoal-400 mt-0.5">Surveillance globale de la productivité et de l'assiduité</p>
                </div>
            </div>
        </template>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-2xl border border-pearl-200 p-6 shadow-premium hover:shadow-gold-premium transition-all duration-300 group overflow-hidden relative">
                ...
                <div class="flex items-start justify-between relative z-10">
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-charcoal-400 mb-2">Heures Supplémentaires (Global)</p>
                ...
                <p class="text-[10px] text-charcoal-400 mt-4 font-medium uppercase tracking-tight italic">Volume cumulé des heures validées</p>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-pearl-200 p-6 shadow-premium hover:shadow-premium transition-all duration-300 group overflow-hidden relative">
                ...
                <div class="flex items-start justify-between relative z-10">
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-charcoal-400 mb-2">Déficit d'heures / Absences</p>
                ...
                <p class="text-[10px] text-charcoal-400 mt-4 font-medium uppercase tracking-tight italic">Total des manquements horaires</p>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-pearl-200 p-6 shadow-premium hover:shadow-premium transition-all duration-300 group overflow-hidden relative">
                ...
                <div class="flex items-start justify-between relative z-10">
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-charcoal-400 mb-2">Écarts Sévères (> 5h)</p>
                ...
                <p class="text-[10px] text-charcoal-400 mt-4 font-medium uppercase tracking-tight italic">Cas nécessitant une intervention</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-pearl-200 shadow-premium p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <h2 class="text-lg font-black text-charcoal-700 tracking-tight uppercase">Registre des Écarts Détectés (Tous Agents)</h2>
            </div>
            ...
            <DataTable :value="timesheets" :loading="loading" stripedRows responsiveLayout="scroll" 
                ...
                <template #empty>
                    <div class="text-center py-12 text-charcoal-300 flex flex-col items-center gap-4">
                        ...
                        <p class="font-bold tracking-wide uppercase text-[10px]">Aucune anomalie majeure à signaler actuellement.</p>
                    </div>
                </template>
