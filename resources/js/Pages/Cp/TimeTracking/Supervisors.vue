...
// Dummy SUP team members
const supervisors = ref([
    { id: 4, name: 'David Martin' },
        ...
        <Dialog v-model:visible="displayCreateDialog" header="Créer une Feuille de Temps (SUP)" :style="{ width: '400px' }" modal>
            <div class="flex flex-col gap-4 mt-2">
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown id="employee" v-model="newTimesheet.employee_id" :options="supervisors" optionLabel="name" optionValue="id" placeholder="Sélectionner un superviseur" class="w-full" />
                </div>
                <div class="flex flex-col gap-2">
