...
const performSearch = () => {
    router.get(route('admin.assignments.schedules'), { search: search.value }, {
        preserveState: true,
        replace: true
    });
};
        ...
        <template #header>
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3 mt-1">
                        ...
                        <div class="relative group flex items-center gap-2">
                            ...
                            <button 
                                @click="performSearch"
                                class="px-3 py-1.5 bg-gold-gradient text-white rounded-lg text-[10px] font-black uppercase tracking-widest hover:opacity-90 transition-all shadow-gold"
                            >
                                Rechercher
                            </button>
                        </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <Link :href="route('admin.assignments.schedules.assign-tc')" class="px-4 py-2 bg-white border border-pearl-200 rounded-lg text-xs font-bold text-charcoal-600 hover:bg-pearl-50 transition-all flex items-center gap-2 shadow-sm">
