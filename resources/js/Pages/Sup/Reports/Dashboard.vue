...
<template>
    <Head title="Performance de l'équipe" />

    <SupLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Suivi de Performance (SUP)</h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                        <template #title>Mes Campagnes</template>
                        <template #content>
                    ...
                    <Card>
                        <template #title>Productivité TC</template>
                        <template #content>
                            <DataTable :value="topEmployees" class="p-datatable-sm">
                                <Column field="name" header="Téléconseiller"></Column>
                                <Column field="hours" header="Heures"></Column>
                            </DataTable>
                        </template>
                    </Card>
                </div>
                ...
                <Card>
                    <template #title>Activité hebdomadaire</template>
                    <template #content>
