...
const submitReport = () => {
    form.post(route('sup.reports.store'), {
        onSuccess: () => {
    ...
    <SupLayout>
        <template #header>
            <div class="flex justify-between items-center gap-2">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Rapports Journaliers</h2>
                <div class="flex gap-2">
                    <a :href="route('sup.reports.export')" class="p-button p-component p-button-secondary">
